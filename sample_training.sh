...
## Performance: Instance AUROC: 0.996, Pixelwise AUROC: 0.982, PRO: 0.949
#python bin/run_patchcore.py --seed 88 --save_patchcore_model --log_group IM320_Ensemble_L2-3_P001_D1024-384_PS-5_AN-5_S88 --log_project MVTecAD_Results results \
